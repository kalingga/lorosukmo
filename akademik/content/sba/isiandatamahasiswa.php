...
?>
	...
	<form name="form1" action="./?page=isiandatamahasiswa" method="post" enctype="multipart/form-data" onsubmit="return validateStandard(this, 'error');">
		...
		<div id="whatsnew" class="fadecontentwrapper" style="width: 900px;">
			...
			<table style="width:98%" border="0" cellpadding="1" cellspacing="1">
				<tr>
				  <td width="3%">I.</td>
				...
				<tr>
				  ...
				  <td width="3%">2.</td>
				    ...
				    <td width="57%">: <input size="10" type="text" name="edtNIM" id="edtNIM" maxlength="10" required ="1" regexp ="/^\w*$/" realname = "NP. Mahasiswa">
					</td>
				</tr>
				<tr>
				  <td>&nbsp;</td>
...
?>
						di&nbsp;:&nbsp;<input size="10" type="text" name="edtKelBelajar" id="edtKelBelajar" maxlength="10">				  
				  </td>
			  </tr>
				<tr>
				  <td>&nbsp;</td>
