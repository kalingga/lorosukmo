     ...
     if ($MySQL->num_rows()) {
	     while ($show=$MySQL->Fetch_Array()){
			...
			echo "<tr>";
	     	...
	     	if ($akses_user == $show['KDFAKMSFAK']) {
				echo "<a href='./?page=".$page."&amp;p=edit&amp;id=".$show['IDX']."'><img border='0' src='images/b_edit.png' title='EDIT DATA' /></a></td>";
			} else {
				echo "<a href='./?page=".$page."&amp;p=view&amp;id=".$show['IDX']."'><img border='0' src='images/b_view.png' title='LIHAT DATA' /></a></td>";
			}
	     	echo "</tr>";
	     	$no++;
		}
