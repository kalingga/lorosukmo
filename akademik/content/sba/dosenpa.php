...
//************** Simpan Data ***********************
	...
	if (isset($_POST['submit'])){
	  	...
	  	$edtKelas=substr(strip_tags($_POST['cbProdi']),0,2);
		...
		if ($simpan=='Simpan'){
			...
			$edtID=$_POST['edtID'];
	  		$MySQL->Update("dsnpaupy","THSMSDSNPA='$ThnSemester',KDPSTDSNPA='$cbProdi',KELASDSNPA='$edtKelas',KDFAKDSNPA='$fakultas',NODOSDSNPA='$cbDosen',NMDOSDSNPA='$nama_dosen',GELARDSNPA='$gelar_dosen'","where IDX=".$edtID,"1");
	  		$msg=$msg_edit_data;
...
?>
		...
		<tr>
	 		...
	 		<td>: <input type="text" name="edtKelas" size="4" maxlength="2"  value="<?php echo $edtKelas ?>"></td>
		</tr>
		<tr>
       ...
       $qry="left join mspstupy on dsnpaupy.KDPSTDSNPA=mspstupy.IDPSTMSPST ";
	 	switch ($level_user) {
	 		case '1':
	 			...
	 			$qry .= "where dsnpaupy.KDPSTDSNPA IN $pst ";
	 			break;
	 		case '2':
	 			$qry .= "where dsnpaupy.KDPSTDSNPA = '".$akses_user."'";
	 			break;
	 	}
