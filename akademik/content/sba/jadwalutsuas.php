...
<?php 
			if ($level_user=='1') {
				LoadProdi_X("cbProdi","",$akses_user,"required='1' exclude='-1' err='Pilih Salah Satu dari Daftar Program Studi yang Ada!'");
			} else {
				echo LoadProdi_X("",$akses_user);
				echo "<input type='hidden' name='cbProdi' value='$akses_user'>";
			}	
?>
			 </td>
			</tr>
...
<?php
			...
			if ($row > 0) {
				...
				for ($i=0;$i < $row; $i++){
					...
					//********** Tabel Detail
			     	$MySQL->Select("tbmksajiupy.IDX,tbmksajiupy.KELASMKSAJI,tbmksajiupy.NODOSMKSAJI,tbmksajiupy.NMDOSMKSAJI,tbmksajiupy.RUANGMKSAJI,tbmksajiupy.HRPELMKSAJI,tbmksajiupy.MULAIMKSAJI,tbmksajiupy.DURSIMKSAJI","tbmksajiupy",
    	...
    	LEFT JOIN ruang_kuliah AS r3 ON RUANG3 = r3.ruangId ";
			...
			$MySQL->Select("jwlutsuas.IDX,jwlutsuas.KDKMKUTSUAS,tblmkupy.NAMKTBLMK,jwlutsuas.KELASUTSUAS,jwlutsuas.RUANGUTSUAS, r1.ruangNama AS R1, r2.ruangNama AS R2,r3.ruangNama AS R3,jwlutsuas.JENISUTSUAS,jwlutsuas.HRPELUTSUAS,jwlutsuas.TGPELUTSUAS,jwlutsuas.WKPELUTSUAS,jwlutsuas.DURSIUTSUAS,jwlutsuas.RUANGUTSUAS,jwlutsuas.NODOSUTSUAS,jwlutsuas.PENG1UTSUAS,jwlutsuas.PENG2UTSUAS,jwlutsuas.PENG3UTSUAS,jwlutsuas.PENG4UTSUAS","jwlutsuas",$qry,"jwlutsuas.JENISUTSUAS ASC,jwlutsuas.KDKMKUTSUAS ASC,jwlutsuas.KELASUTSUAS ASC","");
			//echo $MySQL->qry; exit; 
