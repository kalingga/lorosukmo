...
//		if (isset($_REQUEST["key"])) $key = $_REQUEST["key"];
	...
	;
	    ...
	    echo "</td></tr></form>";
	  	...
	  	$qry ="LEFT OUTER JOIN mspstupy mspstupy on (msmhsupy.KDPSTMSMHS = mspstupy.IDPSTMSPST) WHERE msmhsupy.STMHSMSMHS IN ('A','C','N') AND msmhsupy.KDPSTMSMHS IN ".$prive_user;
		if (!empty($key)) {
