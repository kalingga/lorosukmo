...
//echo $MySQL->qry;
			...
			echo "<table border='0' align='center' style='width:80%; cellpadding='2' cellspacing='1' margin:10px auto; overflow:scroll' class='tblbrdr' >";
			echo "<tr><td colspan='8' style='background-color:#FFF'><button type='button' onClick=window.location.href='./?page=konversinilai&amp;p=add&amp;id=$id' /><img src='images/b_add.png' class='btn_img'>&nbsp;Tambah Data</button></td></tr>";
			echo "<tr>
				<th style='width:50px;'>NO</th>
				<th style='width:100px;'>KODE</th>
				<th>MATAKULIAH</th>
