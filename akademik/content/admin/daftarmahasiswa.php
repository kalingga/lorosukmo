		 ...
		 if ($MySQL->Num_Rows() > 0){
		     while ($show=$MySQL->Fetch_Array()){
				...
				echo "<a href='./?page=daftarmahasiswa&amp;p=edit&amp;id=".$show['IDX']."'><img border='0' src='images/b_edit.png' title='EDIT DATA' /></a> ";
		     	echo "</td>";
		     	//echo "<td class='$sel tac'>";
			//	echo "<a href='./?page=daftarmahasiswa&amp;p=delete&amp;id=".$show['IDX']."'><img border='0' src='images/b_drop.png' title='HAPUS DATA' onclick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data Ini?')\"/></a> ";
		     	//echo "</td>";	     	
		     	echo "</tr>";
		     	$no++;
		     }
