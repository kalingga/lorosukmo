...
;
	...
	/*********** From Pencarian ************/
     ...
     echo "</td></tr></form>";
     echo "<tr><td colspan='6'><button type=\"button\" style='tar' onClick=window.location.href='./?page=dosenpa&amp;p=add'><img src=\"images/b_add.png\" class=\"btn_img\"/>&nbsp;Tambah Data</button></td></tr>";
     ...
     <th>DOSEN PA</th> 
      ...
      $MySQL->Select("dsnpaupy.IDX,dsnpaupy.THSMSDSNPA,dsnpaupy.NODOSDSNPA,dsnpaupy.NMDOSDSNPA,dsnpaupy.GELARDSNPA,mspstupy.NMPSTMSPST","dsnpaupy",$qry,"dsnpaupy.THSMSDSNPA,mspstupy.NMPSTMSPST DESC","$start,$perpage");
      $no=1;
      if ($MySQL->Num_Rows() > 0){
