...
*/	
	...
	//echo "ANGKATAN MAHASISWANYA : ".$_SESSION["angkatan"];
...
//	}
	...
	switch ($id_group) {
		case '0'  : include "./content/admin/hasilstudi.php";
					break;
		case '1'  : include "./content/admin/hasilstudi.php";
					break;
		case '2'  : include "./content/mahasiswa/hasilstudi.php";
					break;
		case '3'  : include "./content/dosen/hasilstudi.php";
					break;
		case '4'  : include "./content/admin/hasilstudi.php";
					break;
		case '5'  : include "./content/admin/hasilstudi.php";
					break;		
		case '10'  : include "./content/admin/hasilstudi.php";
					break;		
