		...
		****** Program Studi dan Tahun Semester Mahasiswa Bersangkutan ****/
			...
			//	    	while ($show=$MySQL->Fetch_Array()){
				for ($i=0;$i < $row; $i++){
					...
					//********** Tabel Detail
			     	$MySQL->Select("tbmksajiupy.IDX,tbmksajiupy.KELASMKSAJI,tbmksajiupy.NODOSMKSAJI,tbmksajiupy.NMDOSMKSAJI,tbmksajiupy.RUANGMKSAJI,tbmksajiupy.HRPELMKSAJI,tbmksajiupy.MULAIMKSAJI,tbmksajiupy.DURSIMKSAJI","tbmksajiupy","WHERE tbmksajiupy.KDKMKMKSAJI = '".$data[$i][1]."'","tbmksajiupy.KELASMKSAJI ASC","");
