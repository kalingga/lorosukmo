...
if($MySQL->Num_Rows() > 0){ 
	...
	"LEFT JOIN msmhsupy ON NIMHSMSMHS = ijazahNIM
	WHERE KDPSTMSMHS = '$kode_prodi' ",
        "ijazahId DESC LIMIT 1");
...
<div align="center" class="style4">  IJAZAH</div>
...
Terakreditasi  berdasarkan Keputusan BAN-PT <span class="style9">Nomor '.$no_ban.'</span> tanggal '.FormatDateTime(strToTime($tglAkrd),2).'.<br>
  Yang bersangkutan dinyatakan lulus pada tanggal '.$lulus.' sehingga kepadanya diberikan gelar:<br>
  <span class="style13">'.$gelar.' <br>
  </span>dengan  segala hak, wewenang, dan kewajiban yang melekat pada gelar tersebut.<br>
    Diberikan di Yogyakarta, pada tanggal '.$wisuda.' </span><strong><br>
    </strong><br><br>
</p>
<div align="center" class="style5"> <br> </div>
<div align="right">
  <table width="990" border="0" align="center">
    <tr>
      ...
      <td width="280"><p align="center" class="style7"><center>Rektor</p><br>
          <br>
          <br>
          <br>
          <br>
