...
WHERE trnlmupy.THSMSTRNLM = '".$tahun_akademik."' AND trnlmupy.NIMHSTRNLM = '".$data[0]."' AND trnlmupy.STATUTRNLM = '1' AND trnlmupy.ISKONTRNLM <> '1'","trnlmupy.KDKMKTRNLM ASC","");
			...
			for ($i=0; $i < $jml_mk;$i++) {
				$MySQL->Select("jwlutsuas.KELASUTSUAS,jwlutsuas.HRPELUTSUAS,jwlutsuas.TGPELUTSUAS,jwlutsuas.WKPELUTSUAS,jwlutsuas.DURSIUTSUAS,jwlutsuas.RUANGUTSUAS","jwlutsuas",
