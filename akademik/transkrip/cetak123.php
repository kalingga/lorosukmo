...
class PDF extends FPDF
{
  ...
  header("Expires: 0");
	...
	echo "<table>";
  echo "<tr><td></td><td rowspan='4' colspan='2'><img  align=CENTER src='".$this->curPageURL()."upywarna.gif' width='80' height='80'>";
  ...
  echo "<br>";
  echo "<table>";
  echo "<TR><TD colspan='11' align='right'>Yogyakarta, ".date('d F Y')."</TD><td>=5*3</td></TR>";
  echo "</table>";
...
if(!isset($submit)){
	...
	<CENTER>
	<p><img src="upywarna.gif" width="101" height="101"></p>
    <TABLE border="1">
	<TR>
	<TD>
    ...
    <form method="post" action="">
        ...
        <table>
			...
			<tr>
			<td>
			<input type="submit" name="submit" value="Transkrip"/>
			</td></tr>
		</table>
